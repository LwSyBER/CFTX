...
def get_plate_variables(Name_plate):
    ...
    if Name_plate == 'plate 0':
        plate_info['Excel_file'] = 'INPUT//231107_ECHO_DNA_plate0_fluoMax_data.xlsm'
        ...
        plate_info['name_ref_plus_MG'] = "P0_Ref+"
        plate_info['name_ref_plus_GFP'] = "P0_Ref+"
        
    elif Name_plate == 'plate 1':
        plate_info['Excel_file'] = 'INPUT//231221_ECHO_DNA_plate1_fluoMax_data.xlsm'
        plate_info['DF_data_GFP'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_GFP', header=None, index_col=0)
        plate_info['DF_data_MG'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_MGapt', header=None, index_col=0)
        plate_info['Time_step'] = 6.116667
        ...
        plate_info['Excel_file'] = 'INPUT//240115_ECHO_DNA_plate2_fluoMax_data.xlsm'
        plate_info['DF_data_GFP'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_GFP', header=None, index_col=0)
        plate_info['DF_data_MG'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_MGapt', header=None, index_col=0)
        plate_info['Time_step'] = 6.116667
        ...
        plate_info['Excel_file'] = 'INPUT//240131_ECHO_DNA_plate3_fluoMax_data.xlsm'
        plate_info['DF_data_GFP'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_GFP', header=None, index_col=0)
        plate_info['DF_data_MG'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_MGapt', header=None, index_col=0)
        plate_info['Time_step'] = 6.116667
        ...
        plate_info['Excel_file'] = 'INPUT//240212_ECHO_DNA_plate4_fluoMax_data.xlsm'
        plate_info['DF_data_GFP'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_GFP', header=None, index_col=0)
        plate_info['DF_data_MG'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_MGapt', header=None, index_col=0)
        plate_info['Time_step'] = 6.116667
        ...
        plate_info['Excel_file'] = 'INPUT//240314_ECHO_DNA_plate5_fluoMax_data.xlsm'
        plate_info['DF_data_GFP'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_GFP', header=None, index_col=0)
        plate_info['DF_data_MG'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_MGapt', header=None, index_col=0)
        plate_info['Time_step'] = 6.116667
        ...
        plate_info['Excel_file'] = 'INPUT//240319_ECHO_DNA_plate6_fluoMax_data.xlsm'
        plate_info['DF_data_GFP'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_GFP', header=None, index_col=0)
        plate_info['DF_data_MG'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_MGapt', header=None, index_col=0)
        plate_info['Time_step'] = 6.116667
        ...
        plate_info['Excel_file'] = 'INPUT//240327_ECHO_DNA_plate7_fluoMax_data.xlsm'
        plate_info['DF_data_GFP'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_GFP', header=None, index_col=0)
        plate_info['DF_data_MG'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_MGapt', header=None, index_col=0)
        plate_info['Time_step'] = 6.116667
        ...
        plate_info['Excel_file'] = 'INPUT//240403_ECHO_DNA_plate8_fluoMax_data.xlsm'
        plate_info['DF_data_GFP'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_GFP', header=None, index_col=0)
        plate_info['DF_data_MG'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_MGapt', header=None, index_col=0)
        plate_info['Time_step'] = 6.116667
        ...
        plate_info['Excel_file'] = 'INPUT//240410_ECHO_DNA_plate9_fluoMax_data.xlsm'
        plate_info['DF_data_GFP'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_GFP', header=None, index_col=0)
        plate_info['DF_data_MG'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_MGapt', header=None, index_col=0)
        plate_info['Time_step'] = 6.116667
        ...
        plate_info['Excel_file'] = 'INPUT//240417_ECHO_DNA_plate10_fluoMax_data.xlsm'
        plate_info['DF_data_GFP'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_GFP', header=None, index_col=0)
        plate_info['DF_data_MG'] = pd.read_excel(plate_info['Excel_file'], sheet_name='Data_MGapt', header=None, index_col=0)
        plate_info['Time_step'] = 6.116667
...
def get_initial_conditions(name_plate):
    ...
    """
    if name_plate == "plate 0":
        DF_sampling = pd.read_excel('INPUT//231107_ECHO_DNA_plate0_fluoMax_data.xlsm', sheet_name='sampling')
        DF_sampling.set_index('Buffer', inplace=True)
        DF_sampling = DF_sampling.iloc[:, :8]
        return DF_sampling
    elif name_plate == "plate 1":
        DF_sampling = pd.read_excel('INPUT//231221_ECHO_DNA_plate1_fluoMax_data.xlsm', sheet_name='sampling')        
        DF_sampling.set_index('Buffer', inplace=True)
        DF_sampling = DF_sampling.iloc[:, :8]
        return DF_sampling
    elif name_plate == "plate 2":
        DF_sampling = pd.read_excel('INPUT//240115_ECHO_DNA_plate2_fluoMax_data.xlsm', sheet_name='sampling')
        ...
        DF_sampling = pd.read_excel('INPUT//240131_ECHO_DNA_plate3_fluoMax_data.xlsm', sheet_name='sampling')        
        nbr_bff_wo_triplicates = len(DF_sampling) // nbr_replicate
        DF_sampling = DF_sampling.head(nbr_bff_wo_triplicates)
        DF_sampling = DF_sampling.set_index(pd.Index(list_strains))
        DF_sampling = DF_sampling.iloc[:, :8]
        ...
        DF_sampling = pd.read_excel('INPUT//240212_ECHO_DNA_plate4_fluoMax_data.xlsm', sheet_name='sampling')        
        nbr_bff_wo_triplicates = len(DF_sampling) // nbr_replicate
        DF_sampling = DF_sampling.head(nbr_bff_wo_triplicates)
        DF_sampling = DF_sampling.set_index(pd.Index(list_strains))
        DF_sampling = DF_sampling.iloc[:, :8]
        ...
        DF_sampling = pd.read_excel('INPUT//240314_ECHO_DNA_plate5_fluoMax_data.xlsm', sheet_name='sampling')        
        nbr_bff_wo_triplicates = len(DF_sampling) // nbr_replicate
        DF_sampling = DF_sampling.head(nbr_bff_wo_triplicates)
        DF_sampling = DF_sampling.set_index(pd.Index(list_strains))
        DF_sampling = DF_sampling.iloc[:, :8]
        ...
        DF_sampling = pd.read_excel('INPUT//240319_ECHO_DNA_plate6_fluoMax_data.xlsm', sheet_name='sampling')        
        nbr_bff_wo_triplicates = len(DF_sampling) // nbr_replicate
        DF_sampling = DF_sampling.head(nbr_bff_wo_triplicates)
        DF_sampling = DF_sampling.set_index(pd.Index(list_strains))
        DF_sampling = DF_sampling.iloc[:, :8]
        ...
        DF_sampling = pd.read_excel('INPUT//240327_ECHO_DNA_plate7_fluoMax_data.xlsm', sheet_name='sampling')        
        nbr_bff_wo_triplicates = len(DF_sampling) // nbr_replicate
        DF_sampling = DF_sampling.head(nbr_bff_wo_triplicates)
        DF_sampling = DF_sampling.set_index(pd.Index(list_strains))
        DF_sampling = DF_sampling.iloc[:, :8]
        ...
        DF_sampling = pd.read_excel('INPUT//240403_ECHO_DNA_plate8_fluoMax_data.xlsm', sheet_name='sampling')        
        nbr_bff_wo_triplicates = len(DF_sampling) // nbr_replicate
        DF_sampling = DF_sampling.head(nbr_bff_wo_triplicates)
        DF_sampling = DF_sampling.set_index(pd.Index(list_strains))
        DF_sampling = DF_sampling.iloc[:, :8]
        ...
        DF_sampling = pd.read_excel('INPUT//240410_ECHO_DNA_plate9_fluoMax_data.xlsm', sheet_name='sampling')        
        nbr_bff_wo_triplicates = len(DF_sampling) // nbr_replicate
        DF_sampling = DF_sampling.head(nbr_bff_wo_triplicates)
        DF_sampling = DF_sampling.set_index(pd.Index(list_strains))
        DF_sampling = DF_sampling.iloc[:, :8]
        ...
        DF_sampling = pd.read_excel('INPUT//240417_ECHO_DNA_plate10_fluoMax_data.xlsm', sheet_name='sampling')        
        nbr_bff_wo_triplicates = len(DF_sampling) // nbr_replicate
        DF_sampling = DF_sampling.head(nbr_bff_wo_triplicates)
        DF_sampling = DF_sampling.set_index(pd.Index(list_strains))
        DF_sampling = DF_sampling.iloc[:, :8]
...
def barplot_one_plate(DF_results_yield, fluo_or_yield, MG_or_GFP='MG'):
    ...
    if MG_or_GFP == 'MG':
        colors = ['red' if 'Ref' in buffer_name else 'chocolate' if name_ref_plus_MG in buffer_name else 'coral' for buffer_name in DF_results_yield.index]
    elif MG_or_GFP == 'GFP':
        colors = ['green' if 'Ref' in buffer_name else 'olivedrab' if name_ref_plus_GFP in buffer_name else 'yellowgreen' for buffer_name in DF_results_yield.index]
    ...
    if MG_or_GFP == 'MG':
        colors_sorted = ['red' if 'Ref' in buffer_name else 'chocolate' if name_ref_plus_MG in buffer_name else 'coral' for buffer_name in DF_results_yield_sorted.index]
    elif MG_or_GFP == 'GFP':
        colors_sorted = ['green' if 'Ref' in buffer_name else 'olivedrab' if name_ref_plus_GFP in buffer_name else 'yellowgreen' for buffer_name in DF_results_yield_sorted.index]
...
def list_strains_controls(Name_plate):
    ...
    if Name_plate == 'plate 5':
        list_strains_to_trace = ['P0_Buffer 6','P0_Ref-','P0_Buffer 68','P0_H20','P0_Buffer 18','P0_Ref+','P1_Buffer 44','P1_Buffer 25','P2_Buffer 38','P3_Buffer 9']
    else :
...
def plot_control_buffers(dico_strains_wells, DF_results_fluo, nbr_controls, name_ref_plus, list_strains_to_trace, Name_plate, MG_or_GFP='MG'):
    ...
    if MG_or_GFP == 'MG':
        mid_title = 'mRNA'
        colors = ['red' if 'Ref' in buffer_name else 'chocolate' if name_ref_plus in buffer_name else 'coral' for buffer_name in DF_results_fluo_MG_ctrl.index]
    elif MG_or_GFP == 'GFP':
        mid_title = 'protein'
        colors = ['green' if 'Ref' in buffer_name else 'olivedrab' if name_ref_plus in buffer_name else 'yellowgreen' for buffer_name in DF_results_fluo_MG_ctrl.index]
...
def calc_yield_NaN(dico_strains_wells, DF_data_corr, DF_results_fluo, name_ref_plus):
    ...
    for buffer, well_list in dico_strains_wells.items():
        ...
        Ref_minus_median = DF_results_fluo.loc["P0_Ref-", "Median"]
...
def correct_gain_change(name_ref_plus, name_plate, DF_results_yield, DF_yield_WperW, MG_or_GFP='MG'):
    ...
    Returns:
        Tuple[DataFrame, DataFrame, float]: A tuple containing:
            ...
            - Ratio_Refplus_Refplus: Calculated ratio used for correction.
    """
    ...
    DF_gain_change = DF_gain100_all_data[(DF_gain100_all_data['Buffer'] == name_ref_plus) | (DF_gain100_all_data['Buffer'] == 'P0_Ref+')]
    ...
    DF_gain_change_piv['Ref_plus/P0_Ref+'] = DF_gain_change_piv[f'{MG_or_GFP}_yield_median', name_ref_plus] / DF_gain_change_piv[f'{MG_or_GFP}_yield_median', 'P0_Ref+']
    Ratio_Refplus_Refplus = DF_gain_change_piv.loc['plate 7', (f'{MG_or_GFP}_yield_median', name_ref_plus)]

    # Open file for writing output
    with open(f'correct_gain_change_params_{MG_or_GFP}_{Name_plate}.txt', 'w') as file:
        file.write(DF_gain_change_piv.to_string())
        file.write(f"\nRatio_Refplus_Refplus = {Ratio_Refplus_Refplus}\n")

    # Multiply yield (median and std) of the plate with lower gain by this ratio
    DF_results_yield = DF_results_yield * Ratio_Refplus_Refplus
    Ratio_Refplus_Refplus_newP = DF_results_yield.loc[name_ref_plus, 'Median'] / DF_results_yield.loc['P0_Ref+', 'Median']
    
    # Append new results to the file
    with open(f'correct_gain_change_params_{MG_or_GFP}_{Name_plate}.txt', 'a') as file:
        file.write(f"Ratio_Refplus_Refplus_newP = {Ratio_Refplus_Refplus_newP} in {Name_plate}\n")

    # Multiply yield (_1,_2,_3,_4,_5,_6) of the plate with lower gain by this ratio
    DF_yield_WperW = DF_yield_WperW * Ratio_Refplus_Refplus

    return DF_results_yield, DF_yield_WperW, Ratio_Refplus_Refplus
...
def plot_barplot_heatmap_compil(DF_all_data, name_ref_plus, MG_or_GFP='MG', figsize_x=150, figsize_y=15):
    ...
    colors = ['red' if 'Ref' in buffer_name else 'chocolate' if pattern.search(buffer_name) else 'coral' for buffer_name in DF_barplot_sorted.index] if MG_or_GFP == 'MG' else ['green' if 'Ref' in buffer_name else 'olivedrab' if pattern.search(buffer_name) else 'yellowgreen' for buffer_name in DF_barplot_sorted.index]
    ...
    # Data for heatmap
    Excel_file_param_max_across_plates = 'INPUT//Params_concentration_range.csv'  # The final one after plate 10
...
def plot_barplot_heatmap_compil_plate_per_plate(DF_all_data, name_ref_plus, MG_or_GFP='MG', figsize_x=40, figsize_y=15):
    ...
    # Data for heatmap
    Excel_file_param_max_across_plates = 'INPUT//Params_concentration_range.csv'  # Final file after plate 10
    DF_data_param = pd.read_csv(Excel_file_param_max_across_plates)
    list_max_conc = DF_data_param['maxValue'].tolist()
    list_igdt = DF_data_param['Parameter'].tolist()
...
def boxplot_yield_across_plates(MG_or_GFP='MG'):
    ...
    sns.boxplot(x='name_plate', y=f'{MG_or_GFP}_yield_median', data=DF_all_data_MG_GFP, ax=ax, color='lightgrey')
    ...
    for buffer_name in unique_buffers:
        ...
        sns.swarmplot(x='name_plate', y=f'{MG_or_GFP}_yield_median', data=buffer_data, color=color_dict[buffer_name], size=5, ax=ax)
...
def plot_barplot_all_data_plate_by_plate(DF_all_data_MG_GFP, MG_or_GFP):
    ...
    for plate in plates:
        ...
        if MG_or_GFP == 'MG':
            colors = ['red' if 'Ref' in buffer_name else 'chocolate' if name_ref_plus_MG in buffer_name else 'coral' for buffer_name in plate_data_sorted.index]
        elif MG_or_GFP == 'GFP':
            colors = ['green' if 'Ref' in buffer_name else 'olivedrab' if name_ref_plus_GFP in buffer_name else 'yellowgreen' for buffer_name in plate_data_sorted.index]
...
def plot_correlation_ingredient_vs_yield(DF_all_data_MG_GFP):
    """
    Plot correlation between ingredient concentrations and MG_yield_median,
    colored by plate and highlighting selected buffers.
    """
    # Number and list of unique plates
    list_name_plates = DF_all_data_MG_GFP['name_plate'].unique()
    nbr_names_plates = len(list_name_plates)
    ...
    # List of ingredients to plot
    ingredients = ['Mg-glutamate', 'K-glutamate', 'Amino acid', 'Spermidine', '3-PGA', 'NTPs', 'PEG-8000', 'DNA']

    # Create a figure with 2 rows and 4 columns
    fig, axs = plt.subplots(2, 4, figsize=(10, 5.5), sharey=True)
    axs = axs.flatten()

    for i, ingredient in enumerate(ingredients):
        ax = axs[i]

        # Plot each point colored by plate
        for plate in list_name_plates:
            plate_data = DF_all_data_MG_GFP[DF_all_data_MG_GFP['name_plate'] == plate]
            ax.scatter(plate_data[ingredient], plate_data['MG_yield_median'],
                       color=color_dict[plate], label=plate, alpha=0.3)

        # Highlight specific points with custom styles
        highlight_conditions = [
            {'Buffer': 'P0_Ref+', 'name_plate': 'plate 0', 'color': 'darkviolet', 'size': 70},
            {'Buffer': 'P8_Buffer 9', 'name_plate': 'plate 8', 'color': 'seagreen', 'size': 70},
            {'Buffer': 'P10_Buffer 9', 'name_plate': 'plate 10', 'color': 'lightseagreen', 'size': 70}
        ]

        for condition in highlight_conditions:
            highlight_data = DF_all_data_MG_GFP[
                (DF_all_data_MG_GFP['Buffer'] == condition['Buffer']) & 
                (DF_all_data_MG_GFP['name_plate'] == condition['name_plate'])
            ]
            ax.scatter(highlight_data[ingredient], highlight_data['MG_yield_median'],
                       color=condition['color'], s=condition['size'], 
                       label=f"{condition['Buffer']} ({condition['name_plate']})",
                       edgecolor='black')

        ax.set_xlabel(f'{ingredient} concentration', fontsize=9)
        if i % 4 == 0:
            ax.set_ylabel('MG_yield_median', fontsize=9)

    # Remove any unused subplots
    for j in range(len(ingredients), len(axs)):
        fig.delaxes(axs[j])

    # Add a single legend
    handles, labels = axs[0].get_legend_handles_labels()
    fig.legend(handles, labels, loc='center', bbox_to_anchor=(0.5, -0.12), title='Plate', ncol=4)
...
if re.search(r'\d+', Name_plate) and int(re.search(r'\d+', Name_plate).group()) > 7:
    ...
    DF_results_yield_MG, DF_yield_MG_WperW, Ratio_Refplus_Refplus_MG = correct_gain_change(name_ref_plus_MG, Name_plate, DF_results_yield_MG, DF_yield_MG_WperW, 'MG')
else:
...
selection = ["P0_Ref-", "P0_Ref+", "P10_Buffer 9", "P8_Buffer 9"]
...
#%% PLOT CORRELATION BETWEEN YIELD AND INGREDIENT CONCENTRATION
plot_correlation_ingredient_vs_yield(DF_all_data_MG_GFP)
